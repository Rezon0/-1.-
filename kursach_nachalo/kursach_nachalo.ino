...
#define BOTtoken "2091087322:AAEso1_dr0VxtTxHmX-0anlkqCIP5aH0W10"  // токен бота
#define BOTname "hacker_alarm" // Имя бота
#define BOTusername "hacker_alarm_bot" // Логин бота
...
const char* ssid = "Rezonat0r";  // SSID
const char* password = "8s9n0e9g"; // пароль

//const char* ssid = "Galaxy M211C8E";  // SSID
//const char* password = "123456789"; // пароль

//const char* ssid = "Balu";  // SSID
//const char* password = "01234567"; // пароль
...
//String chat_id = "836036010";   //id личного чата с ботом
String chat_id = "-1001600342951";  //id группового чата с ботом
